...
Entry point per l'esecuzione su Replit
"""
...
def check_environment():
    ...
    if not os.environ.get('REPL_IDENTITY') and not os.environ.get('WEB_REPL_RENEWAL'):
        print("⚠️  Non sembra essere un ambiente Replit")
...
def main():
    """Funzione principale"""
    print("=" * 60)
    print("🚀 GOOGLE MAPS SCRAPER - Replit Edition PRO")
    print("=" * 60)
    print()
